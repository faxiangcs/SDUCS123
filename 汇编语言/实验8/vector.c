...
void __attribute__((optimize("03"),__target__("arch=core-avx2")))
...
void __attribute__((optimize("03"), __target__("arch=icelake-server")))
raw_calc_avx512(void) {
	const uint32_t const0 = 0x12345678;
	const uint32_t const1 = 0x76543210;
	const uint32_t const2 = 0xA0A00505;
	const uint64_t limit = ARRAY_SIZE * 4;
